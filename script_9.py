# Create complete application files for download
import os

# Create the complete Smart Task Manager application in a single file
...
# Save the complete application to a file
with open('smart_task_manager.py', 'w', encoding='utf-8') as f:
    f.write(application_code)

# Create a README file
readme_content = '''# Smart Task Manager with Priority Scheduling
...
print("✓ Complete Smart Task Manager application created!")
print("✓ Files generated:")
print("  - smart_task_manager.py (Main application)")
print("  - README.md (Documentation)")
print("")
print("To run the application:")
print("1. Download both files to your local computer")
print("2. Ensure Python 3.6+ is installed")
print("3. Run: python smart_task_manager.py")
print("")
print("The application includes all requested features:")
print("• Smart priority scheduling with automatic reordering")
print("• Task dependency management with topological sorting") 
print("• Deadline urgency calculation")
print("• Modern Tkinter GUI with color coding")
print("• JSON/CSV persistence")
print("• Real-time priority updates")
